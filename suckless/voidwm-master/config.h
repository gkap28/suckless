...
static char *colors[][3]        = {
	...
	[SchemeTag5] = { color6,        background,     background  },
    [SchemeTag6] = { color8,        background,     background  },
	[SchemeTag7] = { color3,        background,     background  },
	[SchemeTag8] = { color2,        background,     background  },
	[SchemeTag9] = { color9,        background,     background  },
...
static const char *filecmd[]    = { APP_FILE, NULL };
static const char *mailcmd[]    = { APP_MAIL, NULL };
...
static Key keys[]               = {
    ...
    { Mod1Mask,                     XK_r,       spawn,          SHCMD("st -g   60x35 -e /home/george/.local/bin/scripts/logout.sh") },
    { Mod1Mask|ShiftMask,           XK_d,       spawn,          SHCMD("st -g  120x35 -e /home/george/.local/bin/scripts/search.sh") },
    { Mod1Mask,                     XK_v,       spawn,          SHCMD("st -g  120x35 -e /home/george/.local/bin/scripts/menu.sh") },


	{ Mod1Mask,                     XK_q,       xrdb,           {.v = NULL    } },
