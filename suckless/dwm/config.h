...
static char selbgcolor[]                 = "#353535";
static char selbordercolor[]             = "#353535";
static char selfloatcolor[]              = "#353535";
...
static char tagsselbgcolor[]             = "#454545";
...
const char *spcmd3[] = {"st", "-n", "spvsp2", "-g", "120x35", "-e", "./.local/bin/scripts/menu.sh", NULL };
const char *spcmd4[] = {"st", "-n", "menu", "-g", "110x34", "-e", "./.local/bin/scripts/search.sh", NULL };
...
static const Rule rules[] = {
	...
	RULE(.class = "Subl", .tags = 1 << 7)
	RULE(.class = "Firefox", .tags = 1)
	RULE(.class = "Thunar", .tags = 1 << 1)
	RULE(.class = "Thunderbird", .tags = 1 << 8)
	RULE(.instance = "spterm", .tags = SPTAG(0), .isfloating = 1)
	RULE(.instance = "splogout", .tags = SPTAG(1), .isfloating = 1)
	RULE(.instance = "spvsp2", .tags = SPTAG(2), .isfloating = 1)
	RULE(.instance = "menu", .tags = SPTAG(3), .isfloating = 1)
};
